                ...
                <?php
            $kd = $_GET['kode'];
			$sql = mysqli_query($koneksi, "SELECT * FROM konfirmasi WHERE nopo='$kd' AND jenis = 2");
           ...
           <!-- /.row -->
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="update-konfirmasi-cus.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
	                              ...
	                              <a href="index1.php?link=cs" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
                      </form>
                  </div>
