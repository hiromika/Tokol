    ...
    <div class="container">
      ...
      <div id="wrapper">
        ...
        <div class="container">
          ...
          <blockquote class="hero-unit" style="font-size: medium;">
            <b></b>
        ...
        <div class="form-panel">
          <form class="form-horizontal style-form" action="index.html" method="post" enctype="multipart/form-data" name="form1" id="form1">
            <table class="table table-hover table-striped">
              ...
              <tr>
                <td colspan="2">
                  <a href="index.php" class="btn btn-sm btn-danger pull-right">Batal</a>
                  <input type="submit" name="input" value="Simpan" class="btn btn-sm btn-primary pull-right" style="margin-right: 10px;" />
                </td>
              </tr>
            </table>
          </form>
