                                                        ...
                                                        { $no++; ?>
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td><center><?php echo ($data['harga'] > 0)?number_format($data['harga'],0,",","."):'Belum Ditentukan'; ?></center></td>
                                                                    <td><center><?php echo $data['status'];?></center></td>
                                                                    <td><center><div id="thanks">
                                                                        <?php
                                                                            if ($data['status'] == 'Barang Diterima') {
                                                                                ...
                                                                                <?php if ($data['status'] == 'Menuggu Konfirmasi Oleh admin') { ?>
                                                                                    <a class="btn btn-sm btn-success" data-placement="bottom" data-toggle="tooltip" title="Edit Konfirmasi" href="edit-konfirmasi.php?hal=editcus&kode=<?php echo $data['kode'];?>"><span class="glyphicon glyphicon-edit"></span></a>    
                                                                                    <?php }else{ ?>
                                                                                ...
                                                                                <?php }
                                                                                if ($data['status'] == 'Pembayaran Telah di konfirmasi, Menuggu Pengiriman') { ?>
                                                                                    <a class="btn btn-sm btn-success" data-placement="bottom" data-toggle="tooltip" title="Input Resi" href="input-po-kirim.php?hal=tambahcus&nopo=<?php echo $data['kode'];?>"><span class="glyphicon glyphicon-transfer"></span></a>
                                                                                <?php }
                                                                                ?>
